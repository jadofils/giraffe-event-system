...
//       const isCreator =
//         event.createdByUserId === userId || event.organizerId === userId;
...
//     eventId: string
//   ): Promise<{ success: boolean; message: string; data: TicketType[] }> {
//     try {
//       // --- Check cache first ---
...
//         !Object.values(TicketCategory).includes(updateData.ticketCategory)
//       ) {
//         return { success: false, message: "Invalid ticket category provided." };
//       }

//       const updatedTicketType = this.repository.create({
//         ...ticketType,
//         ...updateData,
//       });
...
//       const activeRegistrations = ticketType.registrations?.filter(
//         (reg) => !reg.deletedAt
//       );
...
//           success: false,
//           message:
//             "Cannot activate: Ticket is not within available time window.",
//         };
//       }
