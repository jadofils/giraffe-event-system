...
//     VenueBookingController.getBookingsByOrganizerId
//   );
//   router.get(
//     "/organization/:organizationId",
//     VenueBookingController.getBookingsByOrganizationId
//   );
//   router.get("/status/:status", VenueBookingController.getBookingsByStatus);
//   router.get(
//     "/date-range/:startDate/:endDate",
//     VenueBookingController.getBookingsByDateRange
//   );

//   // Total Amount Route
//   router.get(
//     "/total/:eventId",
//     VenueBookingController.getTotalBookingAmountForEvent
//   );
