...
export class EventController {
  ...
  static async assignVenues(req: AuthenticatedRequest, res: Response): Promise<void> {
    const organizerId = req.user?.userId;
    const { eventId, venueIds }: { eventId: string; venueIds: string[] } = req.body;
  ...
  static async removeVenues(req: AuthenticatedRequest, res: Response): Promise<void> {
    const organizerId = req.user?.userId;
    const { eventId, venueIds }: { eventId: string; venueIds: string[] } = req.body;
