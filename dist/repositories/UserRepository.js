                ...
                if (!user.roleId && !user.role) {
                    ...
                    if (existingRole) {
                        ...
                        if (guestRole) {
                            ...
                            return {
                                message: "System configuration error: Default role not found and provided roleId is invalid.",
                            };
                        }
                    }
                }
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                if (!user.role || currentRoleName === "" || currentRoleName === "guest") {
                    ...
                    return {
                        success: false,
                        message: "User is not currently assigned the GUEST role or has no role assigned. Use updateUserRole for general updates.",
                    };
                }
            }
            catch (error) {
