...
__decorate([
    (0, typeorm_1.Column)({ type: 'enum', enum: EventStatusEnum_1.EventStatus, default: EventStatusEnum_1.EventStatus.DRAFT }),
...
__decorate([
    ...
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsUUID)('4', { message: 'eventCategoryId must be a valid UUID' }),
    __metadata("design:type", String)
], Event.prototype, "eventCategoryId", void 0);
__decorate([
    (0, typeorm_1.Column)({ type: 'uuid', nullable: true }),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsUUID)('4', { message: 'venueBookingId must be a valid UUID' }),
    __metadata("design:type", String)
], Event.prototype, "venueBookingId", void 0);
__decorate([
    (0, typeorm_1.Column)({ type: 'uuid', nullable: true }),
    (0, class_validator_1.IsOptional)(),
...
__decorate([
    (0, typeorm_1.ManyToOne)(() => EventCategory_1.EventCategory, (eventCategory) => eventCategory.events),
    (0, typeorm_1.JoinColumn)({ name: 'eventCategoryId' }),
    __metadata("design:type", EventCategory_1.EventCategory)
], Event.prototype, "eventCategoryRef", void 0);
__decorate([
    (0, typeorm_1.OneToOne)(() => VenueBooking_1.VenueBooking, (venueBooking) => venueBooking.event, { cascade: ['insert', 'update'], onDelete: 'SET NULL' }),
    (0, typeorm_1.JoinColumn)({ name: 'venueBookingId' }),
    __metadata("design:type", VenueBooking_1.VenueBooking)
], Event.prototype, "venueBooking", void 0);
__decorate([
    (0, typeorm_1.OneToMany)(() => VenueBooking_1.VenueBooking, (booking) => booking.event),
    __metadata("design:type", Array)
