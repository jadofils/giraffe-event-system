...
// router.get('/:userId', , isAdmin, RegistrationController.getUserTicketCostSummary);
// router.put('/:id', RegistrationController.updateRegistration);
// // --- Ticket Management Routes ---
// // Get ticket details with calculated price
// router.get("/:id/details", , (req: Request, res: Response) => TicketService.getTicketDetails(req as any, res));
// // Transfer a ticket to another user
// router.put("/:id/transfer", , TicketService.transferTicket.bind(TicketService));
// // Add tickets to a registration (increment quantity)
// router.put("/:id/add-tickets", , TicketService.AddToCartTheNoOfTickets.bind(TicketService));
// // Cancel specific tickets within a registration
// router.put("/:id/cancel", , TicketService.cancelRegistration.bind(TicketService));
// // Resend the ticket email for a registration
// router.post("/:id/resend-ticket", , async (req: Request, res: Response, next: NextFunction) => { // Added NextFunction type
//     try {
