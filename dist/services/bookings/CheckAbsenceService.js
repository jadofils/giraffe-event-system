        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                while (currentDate.getTime() <= endBoundaryDate.getTime()) {
                    ...
                    const dailyBookings = bookedSlots.filter((booking) => { var _a, _b; return booking.events && ((_b = (_a = booking.events[0]) === null || _a === void 0 ? void 0 : _a.startDate) === null || _b === void 0 ? void 0 : _b.toISOString().slice(0, 10)) === currentDateStr; });
                    if (dailyBookings.length === 0) {
                        ...
                        dailyBookings.sort((a, b) => {
                            var _a, _b, _c, _d;
                            const startA = (_b = (_a = a.events[0]) === null || _a === void 0 ? void 0 : _a.startTime) !== null && _b !== void 0 ? _b : ""; // Default to empty string if undefined
                            const startB = (_d = (_c = b.events[0]) === null || _c === void 0 ? void 0 : _c.startTime) !== null && _d !== void 0 ? _d : "";
