...
class TicketService {
    ...
    static getTicketDetails(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const loggedInUserRoles = ((_c = (_b = req.user) === null || _b === void 0 ? void 0 : _b.role) === null || _c === void 0 ? void 0 : _c.roleName) ? [req.user.role.roleName] : [];
            ...
            try {
                ...
                const responseData = {
                    ...
                    event: {
                        ...
                        description: (_r = registration.event) === null || _r === void 0 ? void 0 : _r.description, // Add null check
                    },
                    venue: {
                        venueId: (_s = registration.venue) === null || _s === void 0 ? void 0 : _s.venueId, // Add null check
                        venueName: (_t = registration.venue) === null || _t === void 0 ? void 0 : _t.venueName, // Add null check
                        address: (_u = registration.venue) === null || _u === void 0 ? void 0 : _u.location, // Add null check
                        capacity: (_v = registration.venue) === null || _v === void 0 ? void 0 : _v.capacity, // Add null check
                        manager: (_w = registration.venue) === null || _w === void 0 ? void 0 : _w.manager, // Add null check
                        location: (_x = registration.venue) === null || _x === void 0 ? void 0 : _x.location, // Add null check
                    },
                    totalCost: totalCost
                };
                res.status(200).json({
    ...
    static generateTicketPdf(registrationId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                doc.moveDown();
                // Venue Information
                doc.text(`Venue: ${((_d = registration.venue) === null || _d === void 0 ? void 0 : _d.venueName) || 'N/A'}`);
                doc.text(`Location: ${((_e = registration.venue) === null || _e === void 0 ? void 0 : _e.location) || 'N/A'}`);
                doc.moveDown();
                // Ticket Information
                const ticketPrice = registration.ticketType ? parseFloat(registration.ticketType.price.toString()) : 0;
                const totalCost = ticketPrice * registration.noOfTickets;
                doc.text(`Ticket Type: ${((_f = registration.ticketType) === null || _f === void 0 ? void 0 : _f.ticketName) || 'N/A'}`);
                ...
                doc.text(`Primary Attendee: ${((_g = registration.user) === null || _g === void 0 ? void 0 : _g.lastName) || 'N/A'}`);
                doc.text(`Email: ${((_h = registration.user) === null || _h === void 0 ? void 0 : _h.email) || 'N/A'}`);
                doc.text(`Buyer: ${((_j = registration.buyer) === null || _j === void 0 ? void 0 : _j.lastName) || 'N/A'}`);
                doc.moveDown();
